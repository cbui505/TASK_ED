...
public class TaskFragment extends Fragment implements MakeTaskDialogListener {
    ...
    public void onFinishTaskDialog(final String[] inputText) {
        ...
        if(inputText[0].equals("") || inputText[1].equals("") ||inputText[0].equals(null) || inputText[1].equals(null)) {
            listItems.remove(inputText);
